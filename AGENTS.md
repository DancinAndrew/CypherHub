...
- **[docs/development/develop.md](docs/development/develop.md)** — 開發路線圖、MVP 階段、詳細規格、API/DB 規範、Non-Goals
- **[docs/old/AGENTS.md](docs/old/AGENTS.md)** — 舊版完整規範（含 Repo Layout、Domain Model、Supabase 規則、Coding Rules）
...
| **金流開發** | [.claude/skills/ecpay](.claude/skills/ecpay) — ECPay 官方 Skill（AIO、CheckMacValue、Webhook） |
